# -*- coding: utf-8 -*-
"""cosmic_model_final.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EADU7iSgJtPEEZlhcaCFt_toIxtyDeMW

# PHYS 2600 - Final Project 2: `cosmic rays`

## Motion of Small Objects in the Solar System


## Use this file to make your `cosmic_ray.py` module.
#### The API is described below and starter code is provided.

<font color="green"> This file is due (in draft form)the week of Apr 6- See Canvas. It wll be graded for completeness (a full attempt), not correctness.  (The final submission of your .py file, Apr 23, will be scored for completeness and correctness.) </font>
...
# Work on the Code Below accroding to the API above
"""
